...
const PropertyHomeCard = ({ property }) => {
  ...
  return (
    <div className="shadow-md flex text-center items-center p-3 md:p-5 gap-4 rounded-lg flex-col md:flex-row md:text-left cursor-pointer hover:shadow-primary hover:shadow-md transition duration-300"
