...
const Home = () => {
  ...
  return (
    <div className='lg:mx-24 md:mx-14 mx-10'>
      ...
      <section>
        <div className='py-5'>
          <p className='font-semibold text-2xl mb-2'>Conoce nuestras casas y fincas vacacionales</p>
      ...
      <section>
        <div className='py-5'>
          <p className='font-semibold text-2xl mb-2'>Conoce nuestras categorías</p>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4'>
                ...
                <div className='grid grid-cols-2 gap-2 md:gap-4'>
                  {categories.map((category) => (
                    <CategoryHomeCard key={category.name} img={category.img} category={category.name} />
                  ))}
                </div>
              </div>
            </div>
